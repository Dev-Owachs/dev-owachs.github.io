...
lang: de
title:  Gestalte mit!
preview_image_id: thea-kinder-garten.jpg
preview_text: |
  Der Owachs bietet noch viel offenes Potenzial zum Wohnen und arbeiten. Gerne laden wir dich ein, mit uns zu leben, zu wirken und die Zukunft dieses Ortes aktiv mitzugestalten.
image_metadata:
  - dirname:
    images:
      - {filename: thea-kinder-garten.jpg, alt: ""}
      - {filename: simon-rita.jpg, caption: "Simon & Rita", alt: ""}
...
# Wer ist «der Owachs»?
<div class="flow-root">
  {% include image.liquid id="winter-see.jpg" class="float-inline-start"%}

  Der Hof gehört Joy und Matthias. Das Grünland ist noch bis Ende 2028 an einen Nachbarbetrieb verpachtet, der bei uns 30 Kühe mit Jungen hält.
  <br>
  <br>
...
Dann schreibe uns und löchre uns mit deinen Fragen.
Wir freuen uns auf spannende und neugierige Bewerbungen.

Mail: [matthias.probst@gmail.com](mailto:matthias.probst@gmail.com)  \|  Telefon: 079 382 06 13  \|  [Kontaktformular](/contact)

{% include image.liquid id="phillip-traktor.jpg" class="centered"%}